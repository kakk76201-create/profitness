...
(function () {
  ...
  var PATHS = {
    ...
    // Не шестерёнка: её зубья на 20 пикселях сливаются, а лучи от центра
    // читаются как солнце. Ползунки узнаются как «настройки» однозначно.
    ...
    // Напольные весы: корпус со скруглением и шкала-полукруг со стрелкой.
    // Прежний вариант (квадрат + черта + ножка) читался как буква в рамке.
    scale: '<rect x="3.5" y="3.5" width="17" height="17" rx="3"/><path d="M8 12a4 4 0 0 1 8 0"/><path d="M12 12l2.4-2.2"/>',
